...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "Komal.bhagat@gmail.com", "Komal", "Bhagat", "Bhivpuri", "06-11433823", "Karjat");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "Mansi.Bhagat@gamail.com", "Mansi", "Bhagat", "Thane", "06-87054875", "Mumbai");
			user2.setRole("ROLE_EMPLOYEE");
			
			User user3 = new User("user", pwEncoder.encode("test"), "Komu.Bhagat@gmail.com", "Komu", "Bhagat", "Panvel", "06-18756892", "NaviMumbai");
			user3.setRole("ROLE_USER");	
			User user4 = new User("Suyash", pwEncoder.encode("test"), "Suyu.Mahtare@gmail.com", "Suyu", "Mahtare", "Katrap", "06-83472443", "Badlapur");
			User user5 = new User("Sumarth", pwEncoder.encode("test"), "Samarth.bruinink@gmail.com", "Samarth", "Bruinink", "Khopoli", "06-13644621", "Khalapur");
			User user6 = new User("Manasi", pwEncoder.encode("test"), "m.sonawane@gmail.com", "Manasi", "Sonawane", "Ambernath", "06-90982738", "Thane");
			User user7 = new User("virat", pwEncoder.encode("test"), "Virat.kohli@gmail.com", "Virat", "Kohli", "Chandnichauk", "06-00492182", "Newdehli");
			User user8 = new User("Dinesh", pwEncoder.encode("test"), "d.peerdeman@gmail.com", "Dinesh", "Peerdeman", "Diksal", "06-88720394", "Ulhasnagar");
